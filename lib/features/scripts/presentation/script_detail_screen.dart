        ...
        child: Column(
          ...
          children: [
            ...
            _buildLevelTile(
              context: context,
              level: 2,
              title: 'Level 2: 高速フリック',
              description: '文字入力せず、フリックだけで「覚えた/覚えてない」を仕分けて高速暗記します。',
            ...
            _buildLevelTile(
              ...
              recommended: script.currentLevel >= 4,
              scriptId: script.id,
            ),
            const SizedBox(height: 20),
            OutlinedButton(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildVoiceLevelTile(
              ...
              recommended: script.currentLevel == 5 || script.currentLevel < 5,
              scriptId: script.id,
            ),
            const SizedBox(height: 12),
            _buildVoiceLevelTile(
            ...
            _buildVoiceLevelTile(
              ...
              recommended: script.currentLevel >= 8,
              scriptId: script.id,
            ),
            const SizedBox(height: 20),
            OutlinedButton(
